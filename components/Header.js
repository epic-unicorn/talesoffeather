        ...
        <div className="flex items-center container mx-auto max-w-7xl justify-between h-full">
          ...
          <nav aria-label="Main Menu">
            <ul className="flex items-center space-x-8">              
              ...
              <li className="hover:text-th-accent-light hover:border-th-accent-dark cursor-pointer px-4 py-2 font-extrabold text-th-primary-medium border border-th-primary-dark rounded-md">
                <a
                  className=""
                  id="walletButton"
            ...
            <ul className="flex items-center space-x-6">
              <li>
                <a href="https://opensea.io" target="_blank">
                  <svg
                    className="text-th-primary-medium hover:text-th-accent-light fill-current w-7 h-7"
                    viewBox="0 0 90 90"
