        ...
        <div className="flex items-center container mx-auto max-w-7xl justify-between h-full">
          ...
          <nav aria-label="Main Menu">
            <ul className="flex items-center space-x-8">              
              ...
              <li className="hover:text-th-accent-light hover:border-gray-100 cursor-pointer px-4 py-2 font-extrabold text-th-primary-medium border border-gray-300 rounded-md">
                <a
                  className=""
                  id="walletButton"
